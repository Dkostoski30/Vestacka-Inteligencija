...
# state (zmija, orientacija)
def validate_state(snake, snake_head):
...
def ProdolziPravo(state):
    ...
    if orientacija == 'gore' and validate_state(snake, (snake_head[0], snake_head[1] + 1)):
    ...
    elif orientacija == 'dolu' and validate_state(snake, (snake_head[0], snake_head[1] - 1)):
        snake.append((snake_head[0], snake_head[1] - 1))
    ...
    elif orientacija == 'desno' and validate_state(snake, (snake_head[0] + 1, snake_head[1])):
    ...
    elif orientacija == 'levo' and validate_state(snake, (snake_head[0] - 1, snake_head[1])):
        snake.append((snake_head[0] - 1, snake_head[1]))
...
def SvrtiDesno(state):
    ...
    if orientacija == 'gore' and validate_state(snake, (snake_head[0] + 1, snake_head[1])):
        snake.append((snake_head[0] + 1, snake_head[1]))
        orientacija = 'desno'
        snake_head = snake[-1]
        if snake_head in green_apples:
    ...
    elif orientacija == 'dolu' and validate_state(snake, (snake_head[0] - 1, snake_head[1])):
        snake.append((snake_head[0] - 1, snake_head[1]))
        orientacija = 'levo'
        snake_head = snake[-1]
        if snake_head in green_apples:
    ...
    elif orientacija == 'desno' and validate_state(snake, (snake_head[0], snake_head[1] - 1)):
        snake.append((snake_head[0], snake_head[1] - 1))
        orientacija = 'dolu'
        snake_head = snake[-1]
        if snake_head in green_apples:
    ...
    elif orientacija == 'levo' and validate_state(snake, (snake_head[0], snake_head[1] + 1)):
        snake.append((snake_head[0], snake_head[1] + 1))
        orientacija = 'gore'
        snake_head = snake[-1]
        if snake_head in green_apples:
...
class Snake_Game(Problem):
    ...
    def h(self, node):
        ...
        for apple in green_apples:
            count += manhattan_distance(snake_head, apple)
...
if __name__ == '__main__':
    ...
    snake_problem = Snake_Game((s, tuple(green), orien))
    solution = recursive_best_first_search(snake_problem)
